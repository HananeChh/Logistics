...
import card2 from "../images/truck.jpg"
import card4 from "../images/truck.jpg"
import card3 from "../images/truck.jpg"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body bgg" style={{ overflow: "hidden" }}>
                            <div className='row' >
                                <div className='col'>
                                    <div class="card role"  >
                                        <img src={card4} class="card-img-top" alt="..." style={{ borderRadius: "0%" }} />
                                ...
                                <div className='col'>
                                    <div class="card role">
                                        <img src={card2} class="card-img-top" alt="..." style={{ borderRadius: "0%",height:"55vh" }} />
                                        <div class="card-body py-4 d-flex justify-content-between txtu btnjw">
